			...
			[' A5 - Proposamenaren segurtasun plana',null,
 			...
 			[' A6 - Gainerako Eranskinak', null,
				...
				[' Test' , null,
					...
					[' User acceptace test (UAT)','../Proiektua/MemoriarenEranskinak/UAT.pdf'],
					[' RFP erantzunen hasierako ebaluazioa','../Proiektua/MemoriarenEranskinak/Proposamena RFPekin parekatuta ebaluatzeko txantiloia BP.pdf'],

				],
				['Ikuskaritzak', null, 
					['Ikuskaritza dokumentua', '../Proiektua/ikuskaritza-BP.pdf'],
				],
			]
		],

		[' Sistemaren Espezifikazioa',null,
			[' Glosarioa','../Proiektua/SistemarenEspezifikazioa/glossary.pdf'],
			[' Bisioa','../Proiektua/SistemarenEspezifikazioa/Vision.pdf'],
			[' Betebeharren Espezifikazioa','../Proiektua/SistemarenEspezifikazioa/systemwide_req_spec.pdf'],

			[' Erabilpen kasuak eta jarduera diagramak', null,
				[' Manage Franchise Information','../Proiektua/SistemarenEspezifikazioa/usecase_specification_Manage Franchise Information.pdf',],
